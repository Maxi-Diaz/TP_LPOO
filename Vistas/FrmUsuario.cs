    ...
    public partial class FrmUsuario : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if(tblUsuario.SelectedRows.Count > 0){
                ...
                user.Usr_Id = Convert.ToInt32(tblUsuario.CurrentRow.Cells["usu_id"].Value.ToString());
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            if (tblUsuario.SelectedRows.Count > 0)
            {
                ...
                frm.cmbRol.Text = tblUsuario.CurrentRow.Cells["Rol"].Value.ToString();
                frm.txtApellido.Text = tblUsuario.CurrentRow.Cells["Nombre"].Value.ToString();
                ...
                frm.txtId.Text = tblUsuario.CurrentRow.Cells["usu_id"].Value.ToString();
                frm.ShowDialog();
                Cargar_Usuarios();
            }
            else
